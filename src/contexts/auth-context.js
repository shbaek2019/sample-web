...
export const AuthProvider = (props) => {
  ...
  const skip = () => {
    ...
    const dummyUser = {
      ...
      token:
        "eyJhbGciOiJIUz,UxMiJ9.eyJzdWIiOiIyIiwiaXNzIjoiaXRzc2VfY29tIiwiaWF0IjoxNjc5ODM2OTkzLCJleHAiOjE2Nzk5MjMzOTN9.W1wGNdkVPegzQocZo3OKdmPOCYlAAIjhvCVHl8KAnQRE651ZJZycEcZtCix8Zx4I4P-e8rjbeTYBALPhi73o4w",
      id: 2,
    };
  ...
  const signUp = async (name, email, phoneNumber, password, companyAddress, companyName) => {
    ...
    const registerUserResponse = await fetch("http://localhost:8080/sign-api/sign-up", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
